...
import static pengelolaan_krs.Config.getConnection;
...
public class data_mhs extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/table mahasiswa.png"))); // NOI18N
    ...
    private void btCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCetakActionPerformed
        // TODO add your handling code here:
        try {
            String reportPath = "src/pengelolaan_krs/reportMhs.jasper";
    ...
    private void btEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditActionPerformed
        // TODO add your handling code here:
        try{
                String sql = "UPDATE data_mhs SET "
                    + "nama=?, "
                    + "alamat=?, "
                    + "jk=?, "
                    + "jurusan=?, "
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try{
            java.sql.Connection conn = Config.configDB();
            String sql = "delete from data_mhs where id='"+txtID.getText()+"' ";
            java.sql.PreparedStatement pst = conn.prepareStatement(sql);
    ...
    private void btCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCariActionPerformed
        // TODO add your handling code here:
               try {
                    java.sql.Connection conn = Config.configDB();
                    String sql = "Select * from data_mhs where id='"+txtCari.getText()+"' or nama='"+txtCari.getText()+"'";
                    java.sql.PreparedStatement pst = conn.prepareStatement(sql);
